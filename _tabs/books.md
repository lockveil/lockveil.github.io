...
<style>
.books-page { padding: 8px 0; }
.books-page .page-sub { font-size: 13px; color: rgba(255,255,255,0.4); margin-bottom: 28px; }
...
.book-card { display: flex; flex-direction: column; cursor: pointer; text-decoration: none; }
.book-cover-wrap { position: relative; border-radius: 8px; overflow: hidden; aspect-ratio: 2/3; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); transition: transform 0.3s ease, box-shadow 0.3s ease; }
...
.book-cover-placeholder { width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px; opacity: 0.25; }
...
<div class="books-row">
  <a class="book-card" href="https://drive.google.com/file/d/FILE_ID/preview" target="_blank">
