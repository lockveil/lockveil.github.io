...
.book-card { display: flex !important; flex-direction: column !important; cursor: pointer; text-decoration: none !important; width: 130px; }
...
.book-meta { padding: 8px 2px 0; width: 130px; }
.book-title { font-size: 12px; font-weight: 600; color: rgba(255,255,255,0.85) !important; line-height: 1.4; margin-bottom: 2px; }
.book-author { font-size: 11px; color: rgba(255,255,255,0.35) !important; }
</style>
